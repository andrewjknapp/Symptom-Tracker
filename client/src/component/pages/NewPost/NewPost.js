      ...
      <form>
        ...
        <div className="row">
          ...
          <div className="col-sm-4">
            ...
            <Link to="/landing-page"><button style={{ margin: '0 auto', width: '30%', color: 'white',backgroundColor: '#3D52D5'}}onClick={handleSubmit} className="btn btn-primary my-3">Save</button></Link>
          </div>
