...
function MedicalProfileView(props) {
...
=======
  ...
  return toEditPage ? (
    <Redirect to='/medical-profile' try='hope' />
  ) : (
    <article>
      <h1 className='profile-view-header'>{userName} Medical Profile</h1>
          ...
          <div className='card profile-view-card'>
            <ul className='profile-view-elements list-group-flush list-group'>
              <li className='list-group-item'>
                <span className='list-num'>1. Date of Birth:</span> {DOB}
              </li>
              <li className='list-group-item'>
                <span className='list-num'>2. Sex:</span> {sex}
              </li>
              <li className='list-group-item'>
                <span className='list-num'>3. Gender Identity:</span> {identity}
              </li>
              <li className='list-group-item'>
                <span className='list-num'>4. Medical Conditions:</span>{' '}
                {condition}
              </li>
              {condition === 'None' ? null : (
                <li className='list-group-item'>{conditionInfo}</li>
              )}
              <li className='list-group-item'>
                <span className='list-num'>5. Surgery History:</span> {surgery}
              </li>
              {surgery === 'None' ? null : (
                <li className='list-group-item indent'>
                  Past Surgeries: {surgeryList}
                </li>
              )}
              <li className='list-group-item'>
                <span className='list-num'>6. Medication:</span> {med}
              </li>
              {med === 'None' ? null : (
                <li className='list-group-item indent'>
              ...
              <li className='list-group-item'>
                <span className='list-num'>7. Medication Allergies:</span>{' '}
                {medAllergy}
              </li>
              <li className='list-group-item'>
                <span className='list-num'>8. Latex Allergy:</span> {latex}
              </li>
              <li className='list-group-item'>
                <span className='list-num'>9. Food Allergies:</span> {food}
              </li>
            </ul>
          </div>
        </section>
